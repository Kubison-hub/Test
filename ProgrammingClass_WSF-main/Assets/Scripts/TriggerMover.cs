...
public class TriggerMover : MonoBehaviour
{
    ...
    void Start()
    {
        if (targetObject != null)
        {
            ...
            if (wallObstacle != null)
            {
                ...
                wallObstacle.carveOnlyStationary = false; // upewnij si� �e mo�e carvingowa� podczas ruchu
    ...
    IEnumerator ResetCarving()
    {
        ...
        yield return new WaitForSeconds(0.05f); // kr�tka przerwa by Unity zresetowa� carving
        wallObstacle.carving = true;
